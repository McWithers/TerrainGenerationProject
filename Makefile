...
Main: Main.o First_Person.o Isometric_Render.o World_Map.o EasyBMP.o EasyBMPsample.o 
	$(CC) $(CFLAGS) Main.cpp First_Person.cpp Isometric_Render.cpp World_Map.cpp EasyBMP.o EasyBMPsample.o -o Main
